CREATE TABLE "consistency_dismissals" (
...
--> statement-breakpoint
ALTER TABLE "consistency_dismissals" ADD CONSTRAINT "consistency_dismissals_sweep_id_consistency_sweeps_id_fk" FOREIGN KEY ("sweep_id") REFERENCES "public"."consistency_sweeps"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "consistency_flags" ADD CONSTRAINT "consistency_flags_grant_id_grants_id_fk" FOREIGN KEY ("grant_id") REFERENCES "public"."grants"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_consistency_dismissals_claims" ON "consistency_dismissals" USING btree ("kind","claim_ids");--> statement-breakpoint
