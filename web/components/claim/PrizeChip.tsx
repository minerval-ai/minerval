...
// bounty on a claim, in dollars, double-ruled like the map's prize ring. It
...
export function PrizeChip({ micro, linkTo }: { micro: number; linkTo?: string }) {
  const amount = formatUsd(micro);
  return (
    <Term
      gloss={`A prize of ${amount} is offered for a machine-checked proof or disproof of this claim's formal statement. Offering a prize does not change how the claim is assessed or how important the graph judges it to be; it says only that someone would like the question settled.`}
